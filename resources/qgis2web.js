...
map.getView().fit([13516600.340383, 1946416.145327, 13570952.824689, 1988458.360951], map.getSize());
...
//geocoder - DISABLED
  ...
  // DISABLED: Layer to represent the point of the geocoded address
  ...
  // DISABLED: Variable used to store the coordinates of geocoded addresses
  // var obj2 = {
  // value: '',
  // letMeKnow() {
  ...
  // DISABLED: Variable for storing labels
  // var obj = {
  //     value: '',
  //     get label() {
  //         return this.value;
  ...
  // DISABLED: Function to handle the selected address
  ...
  // DISABLED: Format the result in the autocomplete search bar
  ...
  // DISABLED: Define a class to create the control button for the search bar in a div tag
  ...
  // DISABLED: Function to show you can do something with the returned elements
  // function myHandler(featureCollection) {
  //     //console.log(featureCollection);
  // }

  // DISABLED: URL for API
  // const url = {"Nominatim OSM": "https://nominatim.openstreetmap.org/search?format=geojson&addressdetails=1&",
  // "France BAN": "https://api-adresse.data.gouv.fr/search/?"}
  // var API_URL = "//api-adresse.data.gouv.fr";

  // DISABLED: Create search by adresses component
  ...
  // DISABLED: Address search geocoder
  ...
  // DISABLED: Address search button and input
  // var search = document.getElementsByClassName("photon-geocoder-autocomplete ol-unselectable ol-control")[0];
  // if (search) {
